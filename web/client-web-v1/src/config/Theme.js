// web\client-web-v1\src\config\Theme.js
...
export const footerTheme = {
  ...
  link: `hover:text-yellow-700 transition-colors`,
  divider: `border-t rounded-xl border-gray-700 opacity-30 mb-8`,
  copyright: theme.textColors.secondary,
  legalLink: `${theme.textColors.secondary} hover:text-yellow-700 transition-colors`
};